...
Reads Assets/Tracks/extracted/track_<code>/track.1s and writes the
generated tables in Scripts/Runtime/Gameplay/kart_course_data.c. See docs/ORIGINAL_COURSE.md for the
...
Usage:  python DeveloperTools/AssetPipeline/derive_course_gates.py
"""
...
def load_ktrk_bounds(code):
    """The track AABB and the start-line quad, as Scripts/Runtime/Gameplay/kart_demo_data.c has them.
...
HEADER = '''/* Generated by DeveloperTools/AssetPipeline/derive_course_gates.py. Do not edit.
