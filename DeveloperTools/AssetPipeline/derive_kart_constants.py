"""Verify (or regenerate) the kart constants in Scripts/Runtime/Gameplay/kart_demo_data.c against the
original demo assets.

Inputs, both produced from the demo's own `Data/kart.rho`:

  Assets/Models/Karts/extracted/<kart>/parameter.xml   Dynamics values
  Assets/Models/Karts/meshes/<kart>.ktrk               exported model.1s

To produce them from an installed 2004 demo:

  dotnet DeveloperTools/AssetImporters/rho-safe-index/bin/Release/net9.0/RhoSafeIndex.dll \
      extract-selected "<demo>/Data/kart.rho" Assets/Models/Karts/extracted \
      Assets/Models/Karts/kart.extracted.json

  dotnet DeveloperTools/AssetImporters/track-mesh-exporter/bin/Release/net9.0/TrackMeshExporter.dll \
      export-kart Assets/Models/Karts/extracted/<kart>/model.1s \
      Assets/Models/Karts/meshes/<kart>
...
Usage:  python DeveloperTools/AssetPipeline/derive_kart_constants.py [--emit]
"""
