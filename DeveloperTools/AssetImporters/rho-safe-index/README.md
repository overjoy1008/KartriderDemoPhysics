...
```powershell
dotnet run --project DeveloperTools/AssetImporters/rho-safe-index -- `
  list "C:\path\to\track_forest_I01.rho" `
  "Assets\Tracks\track_forest_I01.manifest.json"
```
...
dotnet run --project DeveloperTools/AssetImporters/rho-safe-index -- `
  ...
  "Assets\Tracks\extracted\track_forest_I01" `
  "Assets\Tracks\track_forest_I01.extracted.json"
```
