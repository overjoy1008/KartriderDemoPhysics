param(
    [string]$MeshDirectory = 'analysis\track-assets\meshes',
    [string]$SharedDirectory = 'analysis\track-assets\shared',
    [string]$OutputFile = 'analysis\track-assets\texture-resolution.json'
)
