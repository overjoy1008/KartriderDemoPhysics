"""Derive the C track constants in src/kart_demo_data.c from the KTRK exports.

Reads analysis/track-assets/meshes/track_<code>.ktrk (produced by
scripts/export_track_meshes.ps1) and prints the TRACKS[] AABB arguments and the
...
Usage:  python scripts/derive_track_constants.py
"""
