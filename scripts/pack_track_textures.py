...
each against the extracted archives in the same order scripts/map_track_textures.ps1
...
def build_source_index(shared_root):
    """Stems lowercased, which is the match scripts/map_track_textures.ps1 makes."""
    index = {}
