...
/* The original's course: a graph of rectangular gates across the road, the
   ...
   Scripts/Runtime/Gameplay/kart_course_data.c already carry the asset-to-world transform. */

/* --- generated asset tables (Scripts/Runtime/Gameplay/kart_course_data.c) --------------------- */
