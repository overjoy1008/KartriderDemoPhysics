/* End-to-end check over the real packed kart models.
   ...
   Scripts/Runtime/Gameplay/kart_demo_data.c are derived from the body submesh alone, so if the body
...
{
    const char *packed_dir = argc > 1 ? argv[1] : "Assets/Models/Karts/packed";
